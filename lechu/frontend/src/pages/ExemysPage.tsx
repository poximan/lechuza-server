...
import styles from "./ExemysPage.module.css";
  ...
  return (
    <>
      ...
      <div className={styles.exemysKpis}>
        ...
        <Card className={styles.exemysTraffic}>
        ...
        <Card className={styles.exemysDisconnected}>
      ...
      <Card className={styles.exemysFocus}>
        <div className={styles.exemysFocusHeader}>
          <div>
        ...
        <div className={styles.exemysFocusBody}>
          <div className={styles.exemysControlsPanel}>
            <strong>Ventana de datos</strong>
            <div className={styles.exemysTimeButtons}>
            ...
            <div className={styles.exemysPagination}>
              <Button
          ...
          <div className={styles.exemysGraphPanel}>
