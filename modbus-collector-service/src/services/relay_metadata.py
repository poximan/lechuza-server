...
class RelayMetadataService:
    ...
    def __init__(self, reader, logger):
        ...
        self._current_profiles_refreshed = set()
        self._current_profile_parts = {}
        self._current_profile_errors = {}
        self._date_formats = {}
        self._date_formats_refreshed = set()
        self._date_format_errors = {}
        self._disturbance_configurations = {}
        self._disturbance_configurations_refreshed = set()
    ...
    def session_ready(self, relay_id: int) -> bool:
        with self._state_lock:
            return (
                relay_id in self._current_profiles_refreshed
                and relay_id in self._date_formats_refreshed
                and relay_id in self._disturbance_configurations_refreshed
            )
    ...
    def session_error(self, relay_id: int) -> str:
        ...
        return "; ".join(dict.fromkeys(errors)) or (
            "Los parametros MiCOM aun no fueron leidos en esta sesion"
        )
