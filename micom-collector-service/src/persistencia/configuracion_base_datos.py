...
DATABASE_DIR = os.path.abspath(_required("MICOM_DATA_DIR"))
DATABASE_NAME = _required("MICOM_DATABASE_NAME")
if os.path.basename(DATABASE_NAME) != DATABASE_NAME or DATABASE_NAME in {".", ".."}:
    raise EnvironmentError(
        "MICOM_DATABASE_NAME debe contener solo el nombre del archivo"
    )
