...
| --- | --- | --- | --- | --- |
| Exemys y detalle GRD | `frontend/src/pages/ExemysPage.tsx` y `ExemysPage.module.css` | `src/web/exemys_api.py` | `src/servicios/exemys/exemys_service.py` | `src/web/clients/modbus_client.py` y `modem_link_monitor_client.py`; no tiene DAO local porque compone fuentes externas |
