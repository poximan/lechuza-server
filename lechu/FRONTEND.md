...
Lechu sirve una aplicacion React y Vite en `/lechu/`. Flask conserva las
...
- La aplicacion React se publica en `/lechu/`.
- Los adaptadores JSON de cada pagina viven bajo `/lechu/api/`.
...
`GET /lechu/api/navigation` informa el modo autenticado y solamente las entradas
...
- `src/servicios`: composición de contratos externos para cada vista.
...
| --- | --- | --- | --- | --- |
| Exemys y detalle GRD | `frontend/src/pages/ExemysPage.tsx` y `ExemysPage.module.css` | `src/web/exemys_api.py` | `src/servicios/exemys/exemys_service.py` | `src/web/clients/grd_client.py` y `modem_link_monitor_client.py`; compone fuentes externas |
...
| Generadores | `frontend/src/pages/GeneratorsPage.tsx` | `src/web/generadores_api.py` | `src/negocio/generadores.py` y `src/servicios/generadores/generadores_service.py` | `src/web/clients/generator_client.py` |
...
| Reles MiCOM | `frontend/src/pages/RelaysPage.tsx` | `src/web/reles_api.py` | `src/servicios/reles/reles_service.py` | `src/web/clients/micom_client.py` |
...
| Mensagelo | `frontend/src/pages/MensageloPage.tsx` | `src/web/mensagelo_api.py` | `src/servicios/mensagelo/mensagelo_service.py` | historial durable consultado al servicio Mensagelo |
