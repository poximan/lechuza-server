...
class MqttClientManager:
    ...
    def __init__(self, logger):
        ...
        # Suscripciones operativas definidas por el contrato de configuracion.
        self.subscriptions = [
    ...
    def publish(self, topic: str, payload, qos: int = 0, retain: bool = False, source: str = "lechu"):
    ...
    def subscribe(self, topic: str, qos: int = 0, source: str = "lechu"):
    ...
    def register_prefix_listener(self, prefix: str, callback: Callable[[str, str], None], source: str = "lechu") -> None:
        """
