...
DATABASE_DIR = os.path.abspath(_required("GRD_DATA_DIR"))
DATABASE_NAME = _required("GRD_DATABASE_NAME")
if os.path.basename(DATABASE_NAME) != DATABASE_NAME or DATABASE_NAME in {".", ".."}:
    raise EnvironmentError(
        "GRD_DATABASE_NAME debe contener solo el nombre del archivo"
    )
